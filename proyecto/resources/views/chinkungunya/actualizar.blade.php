...
@section ('content')
<form method="POST" action="{{route('chinkungunya.update',$chinkungunya)}}">
	@csrf
<div class="container">
   <div class="row mt-4">
       ...
       <div class="col-xs-12 col-sm-4 mt-2">
           <label>Año</label>
           <input type="number" name="anio" class="form form-control form-gray" id="anio" value="{{$chinkungunya->anio}}">
       </div>
       <div class="col-xs-12 col-sm-4 mt-2">
           <label>Casos confirmados</label>
           <input type="number" name="casos" class="form form-control form-gray" id="casos" value="{{$chinkungunya->casos}}">
       </div>
